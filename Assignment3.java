...
public class Assignment3 {
    ...
    static void printAllStudent(int[] ids, String[] studentsName) {
        ...
        for (int index = 0; index < ids.length; index++) {
            if (ids[index] == index + 1) {
                ...
                // [3]:Bernete
                // [4]:Faith
                System.out.println("["+ids[index] +"]"+":"+studentsName[index]);
    ...
    static void miN(String course, int[] ids,String[] name, String[] studentsName, String[] courses, int[] grades) {
        int min = 100;
        ...
        System.out.println(min +" is the lowest Grade in "  + course);

    }
    static void maX(String course, int[] ids,String[] name, String[] studentsName, String[] courses, int[] grades) {
        int max = 0;
        for(int index = 0; index < grades.length; ++index ) {
            if (courses[index].equals(course)) {
                if (grades[index] > max) {
        ...
        System.out.println(max +" is the lowest Grade in " + course);
    ...
    public static void main(String[] args) {
        ...
        //print all students with their id
        ...
        miN("math",ids, studentName ,studentName,course,grade);

        maX("math",ids, studentName ,studentName,course,grade);
